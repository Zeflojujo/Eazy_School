...
import heroGradu from "../../../assets/accountant.jpg"
  ...
  return (
    <>
        ...
        <div className="flex flex-col justify-center h-full items-center text-2xl pb-3 pt-0" >
            <div className="w-full h-60 mb-16 bg-blue-400">
                <img
                    src={heroGradu}
                    alt="donate blooc"
            ...
            <div className="w-5/6 md:w-3/5 mb-16 lg:w-2/5 p-6 md:p-8 rounded-lg text-gray-700 bg-gray-200 shadow-lg shadow-blue-600">
                <Alert />
                <Loading />
                <h1 className="text-2xl md:text-3xl lg:text-3.5xl text-gray-700 font-semibold mb-4">Accountant Login</h1>
