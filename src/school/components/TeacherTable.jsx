...
const TeacherTable = () => {
  ...
  return (
    <>
      ...
      <div className="mb-4">
        <h1 className="text-3xl font-bold text-gray-800 mb-2 dark:text-gray-400">Medical Center Lists</h1>
      </div>
            ...
            <tbody>
              {allTeachers.map((teacher, index) => (
                ...
                >
                  ...
                  <td className={`py-2 px-4 text-gray-700 text-base border-b dark:text-gray-500 ${hoveredRow === index ? 'bg-gray-200 dark:bg-gray-900' : ''}`}>{truncate(teacher.MCPublicAddress, 7, 7, 17)}</td>
