                    ...
                    <div className="w-3/4 mx-auto px-4 py-8">
                        <div className="bg-white shadow-md rounded px-8 py-6 mb-4 dark:bg-[#212936] dark:text-gray-300 dark:shadow-md dark:rounded-md dark:shadow-gray-400">
                            ...
                            <div className="flex flex-col gap-4">
                                <div>
                                    <p className="flex gap-3 text-gray-600 text-xl"><span className=" font-bold ">Public Address:</span><span>My Address</span></p>
                                </div>
                                <div>
                                    <p className="flex gap-3 text-gray-600 text-xl"><span className="font-bold ">Name:</span><span>Josephat</span></p>
                                </div>
                                <div>
                                    <p className="flex gap-3 text-gray-600 text-xl"><span className="font-bold ">Phone Number:</span><span>0719616657</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
