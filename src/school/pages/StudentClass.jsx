...
import { addStudentClass } from '../../BlockchainService'
...
const StudentClass = () => {
    ...
    const handleStudentRegistration = async (e) => {
        ...
        setGlobalState('loading', { show: true, msg: 'Registering Student Class...' })

        try {

            setLoadingMsg('Intializing transaction...')
            // const password = user.lastName;
            const result = await addStudentClass(studentClassCredentials)
            console.log(result)
            ...
            if (result) {
                ...
                swal({  
                    title: "Good job!",  
                    text: "Class registered successfully...!",  
                    icon: "success",  
                    button: "Okay",  
                });  
            ...
            console.log('Error registering Class file: ', error)
                    ...
                    >
                        <div className="shadow-lg rounded-xl w-11/12 md:w-4/5 h-7/12 p-6 bg-gray-100 shadow-blue-600 dark:bg-[#232b35] dark:shadow-blue-600">
                            ...
                            <div className="flex flex-row justify-between items-center">
                                <h1 className="text-2xl md:text-3xl lg:text-3.5xl text-gray-400 mb-4">Add Student Class</h1>
                                <button
                                    type="button"
                                    onClick={closeModal}
                            ...
                            <form className="text-lg" onSubmit={handleStudentRegistration}>
                                ...
                                <div className="grid md:grid-cols-1 gap-x-2 mb-4 w-full mt-4">
                                    ...
                                    <div className="mb-4">
                                        <label htmlFor="classLevel" className='text-lg text-gray-500'>Class Name:</label>
                                        <input
                                            id="classLevel"
                                            type="classLevel"
