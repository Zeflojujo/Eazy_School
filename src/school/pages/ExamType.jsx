...
import { addExamType } from '../../BlockchainService'
...
import StudentExamTypeTable from "../components/StudentExamTypeTable"
...
const ExamType = () => {
    ...
    const handleAddExamType = async (e) => {
        ...
        try {
            ...
            console.log('Error registering exam type file: ', error)
            setAlert('Exam type registration failed...', 'red')
            // swal({  
            //     title: "FAILED!",  
                    ...
                    {/* <div className="flex flex-col justify-center items-center mx-1 md:mx-4 overflow-hidden z-0 my-11 w-full">
                        ...
                        <div className="w-4/5">
                            <button
                                ...
                                onClick={handleAddExamTypeModel}
                    ...
                    >
                        <div className="shadow-lg rounded-xl w-11/12 md:w-4/5 h-7/12 p-6 bg-gray-100 shadow-blue-600 dark:bg-[#232b35] dark:shadow-blue-600">
                            ...
                            <div className="flex flex-row justify-between items-center">
                                <h1 className="text-2xl md:text-3xl lg:text-3.5xl text-gray-400 mb-4">Add Exam-Type</h1>
                                <button
                                    type="button"
                                    onClick={closeModal}
                            ...
                            <form className="text-lg" onSubmit={handleAddExamType}>

                                <div className="grid md:grid-cols-1 gap-x-2 mb-4 w-full mt-4">

                                    <div className="mb-4">
                                        <label htmlFor="examType" className='text-lg text-gray-500'>Exam-Type Name:</label>
                                        <input
                                            id="examType"
                                            type="text"
                                            value={user.examType}
                                            ...
                                            onChange={(e) => setUser({ ...user, examType: e.target.value })}
