...
import { addSubjectDetails, registerSubjectDetails } from '../../BlockchainService'
...
const StudentDetails = () => {
    ...
    const handleAddSubject = async (e) => {
        ...
        const subjectDetailsCredentials = {
            subjectName: user.subjectName,
            classLevel: user.classLevel,
            fullMark: user.fullMark,
            passMark: user.passMark
        }
        ...
        try {
            ...
            console.log('Error registering Subject file: ', error)
            setAlert('Subject registration failed...', 'red')
            // swal({  
            //     title: "FAILED!",  
            //     text: "Subject registration failed...!",  
            //     icon: "warning",  
            //     button: "Okay",  
            // }); 
        }
                    ...
                    >
                        <div className="shadow-lg rounded-xl w-11/12 md:w-4/5 h-7/12 p-6 bg-gray-100 shadow-blue-600 dark:bg-[#232b35] dark:shadow-blue-600">
                            ...
                            <div className="flex flex-row justify-between items-center">
                                <h1 className="text-2xl md:text-3xl lg:text-3.5xl text-gray-400 mb-4">Add Subject</h1>
                                <button
                                    type="button"
                                    onClick={closeModal}
                            ...
                            <form className="text-lg" onSubmit={handleAddSubject}>

                                <div className="grid md:grid-cols-1 gap-x-2 mb-4 w-full mt-4">

                                    <div className="mb-4">
                                        <label htmlFor="subjectName" className='text-lg text-gray-500'>Subject Name:</label>
                                        <input
                                            id="subjectName"
                                            type="subjectName"
                                ...
                                <div className="grid md:grid-cols-3 gap-x-2 mb-4 w-full mt-4">
                                    ...
                                    <div className="mb-4">
                                        <label htmlFor="classLevel" className='text-lg text-gray-500'>Subject Name:</label>
                                        <input
                                            id="classLevel"
                                            type="classLevel"
                                    ...
                                    <div className="mb-4">
                                        <label htmlFor="fullMark" className='text-lg text-gray-500'>Subject Name:</label>
                                        <input
                                            id="fullMark"
                                            type="fullMark"
                                            value={user.fullMark}
                                            className="mt-1 px-3 py-1.5 md:py-2 w-full border border-solid border-gray-600 rounded-md dark:bg-transparent text-gray-700 bg-clip-padding appearance-none"
                                            // className="w-full border-2 border-gray-500 focus:border-blue-300 py-2 px-4 bg-gray-300 mt-2 text-lg text-gray-900 rounded-lg"
                                            onChange={(e) => setUser({ ...user, fullMark: e.target.value })}
                                            placeholder="fullMark"
                                        />
                                    </div>
                                    <div className="mb-4">
                                        <label htmlFor="passMark" className='text-lg text-gray-500'>Subject Name:</label>
                                        <input
                                            id="passMark"
                                            type="passMark"
                                            value={user.passMark}
                                            className="mt-1 px-3 py-1.5 md:py-2 w-full border border-solid border-gray-600 rounded-md dark:bg-transparent text-gray-700 bg-clip-padding appearance-none"
                                            // className="w-full border-2 border-gray-500 focus:border-blue-300 py-2 px-4 bg-gray-300 mt-2 text-lg text-gray-900 rounded-lg"
                                            onChange={(e) => setUser({ ...user, passMark: e.target.value })}
