...
import { addStudentCombination } from '../../BlockchainService'
...
import StudentCombinationTable from "../components/StudentCombination"
                    ...
                    >
                        <div className="shadow-lg rounded-xl w-11/12 md:w-4/5 h-7/12 p-6 bg-gray-100 shadow-blue-600 dark:bg-[#232b35] dark:shadow-blue-600">
                            ...
                            <div className="flex flex-row justify-between items-center">
                                <h1 className="text-2xl md:text-3xl lg:text-3.5xl text-gray-400 mb-4">Add Combination</h1>
                                <button
                                    type="button"
                                    onClick={closeModal}
                            ...
                            <form className="text-lg" onSubmit={handleAddCombination}>

                                <div className="grid md:grid-cols-1 gap-x-2 mb-4 w-full mt-4">

                                    <div className="mb-4">
                                        <label htmlFor="combination" className='text-lg text-gray-500'>Combination Name:</label>
                                        <input
                                            id="combination"
                                            type="combination"
...
export default StudentCombination
